...
public class Compresor { //Comprimir y descomprimir utilizando LZ77 y Huffman
    ...
    public List<String> convertiraString(List<int[]> lz77comprimido)
    {
        ...
        for (int[] data : lz77comprimido)
        {
            int offset = data[0];
            int lengt = data[1];
            char next_char = (char) data[2]; //Acá se obtiene cada uno de los datos 'int' de la tupla
    ...
    //Métodos de Huffman que utiliza montículo
    ...
    ///Huffman que utiliza la coficación LZ77 con tokens String
    ...
    public void compresionArchivo(String entrada, String salida, String nombreArchivo) throws IOException
    {
        ...
        //Agregamos el nuevo árbol Huffman para la posterior decodificación
